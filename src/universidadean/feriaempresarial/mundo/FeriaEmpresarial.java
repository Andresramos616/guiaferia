...
public class FeriaEmpresarial {
    ...
    public String metodo1()  {
                    ...
                    if (puesto.darNombreEmpresa().equals(empresa.darNombre())) {
                        ...
                        if (puesto.darNombreEmpresa().equals(empresa.darNombre())) {
                            if (puesto.darZona() == Puesto.ZONA_NORTE) {
                                northzone += empresa.darNumeroPersonasAsistentes();
                                sw = true;
                            }
                            if (puesto.darZona() == Puesto.ZONA_SUR) {
                                surzone += empresa.darNumeroPersonasAsistentes();
                                sw = true;
                            }
                            if (puesto.darZona() == Puesto.ZONA_ORIENTE) {
                                orienzone += empresa.darNumeroPersonasAsistentes();
                                sw = true;
                            }
                            if (puesto.darZona() == Puesto.ZONA_OCCIDENTE) {
                                ocidentzone += empresa.darNumeroPersonasAsistentes();
                                sw = true;
                            }
                            if (puesto.darZona() == Puesto.ZONA_CENTRO) {
                                centerzone += empresa.darNumeroPersonasAsistentes();
                                sw = true;
                            }
                        }
                    }
        ...
        if (!sw) {
            ...
            if(northzone==surzone&&northzone==orienzone&&northzone==ocidentzone&&northzone==centerzone){
                JOptionPane.showMessageDialog(null, "TODAS LAS ZONAS TIENEN LA MISMACANTIDAD DE EXPOSITORES");
            }else if (northzone>surzone&&northzone>centerzone&&northzone>orienzone&&northzone>ocidentzone){
                JOptionPane.showMessageDialog(null, "LA ZONA NORTE ES LA DE MAYOR CANTIDAD DE EXPOSITORES");

            }else if (surzone>centerzone&&surzone>orienzone&&surzone>ocidentzone){
                JOptionPane.showMessageDialog(null, "LA ZONA SUR ES LA DE MAYOR CANTIDAD DE EXPOSITORES");

            }else if (centerzone>orienzone&&centerzone>ocidentzone){
                JOptionPane.showMessageDialog(null, "LA ZONA CENTRO ES LA DE MAYOR CANTIDAD DE EXPOSITORES");

            }else if (orienzone>ocidentzone){
                JOptionPane.showMessageDialog(null, "LA ZONA ORIENTE ES LA DE MAYOR CANTIDAD DE EXPOSITORES");

            }else {
                JOptionPane.showMessageDialog(null, "LA ZONA OCCIDENTE ES LA DE MAYOR CANTIDAD DE EXPOSITORES");

            }

            return String.valueOf("Cantidad de expositores por zona\n" + " EN LA ZONA SUR : " + surzone + "\nEN LA ZONA NORTE : " + northzone + "\nZONA ORIENTE : " + orienzone + "\nZONA OCCIDENTE : " + ocidentzone + "\nZONA CENTRO : " + centerzone);
        }
...
respuesta =null;
        if (porcentaje>=60){
            respuesta= " SE HA CUMPLIDO EL PUNTO DE EQUILIBRIO";
        }else {
            respuesta= "NO SE HA CUMPLIDO EL PUNTO DE EQUILIBRIO";
        }
